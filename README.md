...
![Обозреватель тестов]("C:\Users\Admin\Downloads\Обозреватель тестов.png")

*p.s. Картинки не вставляются в данный файл никаким образом, хотя в работе №4 мне с легкостью удавалось это сделать через Ctrl C + Ctrl V. Не могу понять, в чем дело :(*
